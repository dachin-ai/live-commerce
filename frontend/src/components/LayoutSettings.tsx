  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 p-3 bg-primary-600 text-white rounded-full shadow-lg hover:bg-primary-700 z-50 transition-all"
        title="布局设置"
      >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-semibold text-slate-900">布局设置</h2>
              <button
                onClick={() => {
                  setIsOpen(false)
                  onClose?.()
            ...
            <div className="space-y-6">
              {/* 功能区显示/隐藏 */}
              <div>
                <h3 className="text-lg font-medium text-slate-900 mb-4">功能区显示/隐藏</h3>
              ...
              {/* 功能区大小调整 */}
              <div>
                <h3 className="text-lg font-medium text-slate-900 mb-4">功能区大小（列数，总共12列）</h3>
                  ...
                  {[
                    ...
                    <div key={key} className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2 flex-1">
                        ...
                        <span className="text-sm text-slate-500 ml-2">列</span>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              {/* 图标显示/隐藏 */}
              <div>
                <h3 className="text-lg font-medium text-slate-900 mb-4">图标显示</h3>
                <button
                ...
                >
                  <span className="font-medium text-slate-900">显示图标</span>
                  {preferences.showIcons ? (
                    <Eye className="w-5 h-5 text-primary-600" />
                  ) : (
                    <EyeOff className="w-5 h-5 text-slate-400" />
              ...
              <div className="flex gap-3 pt-4 border-t border-slate-200">
                <button
                  ...
                  className="flex-1 px-4 py-2 border border-slate-300 rounded-lg hover:bg-slate-50 flex items-center justify-center gap-2"
                >
