...
import ttImportRoutes from './routes/tt-import'
import ttAnalyticsRoutes from './routes/tt-analytics'
import ttBiRoutes from './routes/tt-bi'
...
const TTL_3MIN = 3 * 60 * 1000

// 路由 — 高频只读路由挂载 LRU 缓存中间件
app.use('/api/auth', authRoutes)
app.use('/api/stats', cacheMiddleware(TTL_3MIN), statsRoutes)
...
app.use('/api/tt-import', ttImportRoutes)
app.use('/api/tt-analytics', cacheMiddleware(TTL_3MIN), ttAnalyticsRoutes)
app.use('/api/tt-bi', cacheMiddleware(TTL_3MIN), ttBiRoutes)
